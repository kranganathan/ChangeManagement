 ...
 */
@TestFor(ChangeRequest)
@Mock([Contacts,Comments,Milestones])
class ChangeRequestSpec extends Specification {
    ...
    void "test for request creation with all the request attributes"() {
        when:
        ChangeRequest r1 = new ChangeRequest(category:"Change Management",type:"General",item:"Password Change", title:"Change Password",description:"test",
