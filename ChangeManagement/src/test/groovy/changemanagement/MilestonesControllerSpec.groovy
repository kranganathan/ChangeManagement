...
@Mock([Milestones, ChangeRequest])
class MilestonesControllerSpec extends Specification {

    def populateValidParams(params) {
        assert params != null
        params << [phase:'Submit',milestoneName:'Request Received',milestoneDate:new Date().format("yyyy/MM/dd"), request: new ChangeRequest()]
    }
    ...
    void "Test for notFound method"() {
        when: "The notFound method is called"
        request.contentType = FORM_CONTENT_TYPE
        controller.notFound()
